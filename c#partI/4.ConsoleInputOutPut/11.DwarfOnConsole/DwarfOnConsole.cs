...
class DwarfOnConsole
{
    ...
    static void Main()
    {
        ...
        while(true) 
        {
            ...
            /*if rowsOfRock (how many rows of rocks are there) and the symbol on the same position as the dwarf's head istn a space = collision*/
